...
Release_Percentage = os.environ['Release_Percentage']
...
def addSheet():
    ...
    value_range_body = {
        'values': [
            # [Release_Day, 'PhotoGrid', Release_Version, Release_Type, 'sucess', Release_Percentage, Auto_Upgrade, Sticker, Change_log, Size]
            ["2017/01/01"]
        ]
    }
    credentials = ServiceAccountCredentials.from_json_keyfile_name('FabricParser-8be73c6c3ce6.json', SCOPES)
